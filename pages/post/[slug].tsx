...
import { useEffect, useState } from "react";import {sanityClient, urlFor} from "../../sanity";
...
function Post({post}: Props) {
  ...
  return (
    <main>
        ...
        <img className="w-full h-80 object-cover" src={urlFor(post.mainImage).url()!} alt="Post main image" />
        ...
        <article className="max-w-3xl mx-auto p-5">
          ...
          <div className="flex item-center space-x-2">
            ...
            <p className="font-extralight text-sm">
              Blog post by <span className="text-green-600">{post.author.name}</span> - published {new Date(post._createdAt).toLocaleString()}
            </p>
          </div>
        ...
        {submitted ? (
          ...
          <label className="block mb-5">
            ...
            className="shadow border rounded py-2 px-3 form-input mt-1 block w-full focus:outline-yellow-500"
